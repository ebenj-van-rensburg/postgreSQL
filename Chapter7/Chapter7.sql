...
INSERT INTO unique_constraint_example (first_name, last_name, email)
VALUES ('Sasha', 'Lee', 'slee@example.org'); -- duplicate example
...
FROM 'D:\bootcamp\SQL\source\practical-sql-main\Chapter_07\city_of_new_york.csv'
