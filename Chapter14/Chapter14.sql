...
FROM 'D:\bootcamp\SQL\myCode\Chapter14\farmers_markets.csv'
...
-- Listing 14-12: Using ST_Distance() to calculate the miles between Yankee Stadium and Citi Field (Mets) 1609.344 meters/mile
SELECT ST_Distance(
