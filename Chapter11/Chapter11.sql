...
-- make a date
SELECT make_date(2024, 6, 12);
-- make a time
SELECT make_time(18, 4, 30.3);
-- make a timestamp with time zone
SELECT make_timestamptz(2024, 6, 12, 18, 4, 30.3, 'Europe/Lisbon');
...
SHOW timezone;
-- SHOW ALL timezone; -- Note: You can see all run-time defaults with SHOW ALL;
...
FROM 'D:\bootcamp\SQL\myCode\Chapter11\yellow_tripdata_2016_06_01.csv'
...
TO 'D:\bootcamp\SQL\myCode\Chapter11\yellow_tripdata_2016_06_01_taxi_pickupphour.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
